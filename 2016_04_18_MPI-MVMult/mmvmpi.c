...
double mvallgather(const double *x, const double *mat, double *y,int gn, int ln, int sr, int er, double *tcomm);
double mvring(const double *x, const double *mat, double *y, int gn, int ln, int sr, int er, double *tcomm);
void mvmult(const double *RESTRICT x, const double *RESTRICT mat, double * RESTRICT y, int rows, int cols, int colsdim);
